...
class QActionProto : public QObject, public QScriptable
{
  ...
  public:
    ...
    Q_INVOKABLE int                 menuRole()                       const;
    ...
    Q_INVOKABLE int                 shortcutContext()   const;
