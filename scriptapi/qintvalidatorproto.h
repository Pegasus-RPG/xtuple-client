...
#ifndef __QINTVALIDATORPROTO_H__
#define __QINTVALIDATORPROTO_H__
...
QScriptValue constructQIntValidator(QScriptContext *context, QScriptEngine *engine);

class QIntValidatorProto : public QObject, public QScriptable
{
  Q_OBJECT

  public:
    QIntValidatorProto(QObject *parent);

/*
 * Leaving these out for now as we just need the ability to
 * pass this class without changing anything
    Q_INVOKABLE int bottom () const;
