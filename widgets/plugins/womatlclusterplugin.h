...
class WomatlClusterPlugin : public QObject, public QDesignerCustomWidgetInterface
{
    Q_OBJECT
    Q_INTERFACES(QDesignerCustomWidgetInterface)

  public:
    WomatlClusterPlugin(QObject *parent = 0) : QObject(parent), initialized(false) {}
    ...
    QWidget *createWidget(QWidget *parent) { return new WomatlCluster(parent); }
