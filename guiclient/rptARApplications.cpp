...
/*
 *  Constructs a rptARApplications as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptARApplications::rptARApplications(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptARApplications::~rptARApplications()
{
 ...
 *  language.
 */
void rptARApplications::languageChange()
{
    retranslateUi(this);
}


void rptARApplications::init()
{
...
enum SetResponse rptARApplications::set(ParameterList &pParams)
{
  QVariant param;
  bool     valid;
  ...
  _cashReceipts->setChecked(pParams.inList("showCashReceipts"));
  _creditMemos->setChecked(pParams.inList("showCreditMemos"));
