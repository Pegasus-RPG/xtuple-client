...
/*
 *  Constructs a rptSalesHistoryByShipTo as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSalesHistoryByShipTo::rptSalesHistoryByShipTo(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
    : QDialog(parent, name, modal, fl)
{
  ...
  connect(_shipTo, SIGNAL(valid(bool)), _print, SLOT(setEnabled(bool)));
 ...
 */
rptSalesHistoryByShipTo::~rptSalesHistoryByShipTo()
{
 ...
 *  language.
 */
void rptSalesHistoryByShipTo::languageChange()
{
    retranslateUi(this);
}

enum SetResponse rptSalesHistoryByShipTo::set(const ParameterList &pParams)
{
  QVariant param;
  bool     valid;
...
void rptSalesHistoryByShipTo::sPrint()
{
    if (!_dates->allValid())
    {
