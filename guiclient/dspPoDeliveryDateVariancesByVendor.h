...
class dspPoDeliveryDateVariancesByVendor : public QMainWindow, public Ui::dspPoDeliveryDateVariancesByVendor
{
    Q_OBJECT

public:
    dspPoDeliveryDateVariancesByVendor(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
