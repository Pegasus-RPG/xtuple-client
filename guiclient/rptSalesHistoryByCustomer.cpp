...
/*
 *  Constructs a rptSalesHistoryByCustomer as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSalesHistoryByCustomer::rptSalesHistoryByCustomer(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSalesHistoryByCustomer::~rptSalesHistoryByCustomer()
{
 ...
 *  language.
 */
void rptSalesHistoryByCustomer::languageChange()
{
    retranslateUi(this);
}


void rptSalesHistoryByCustomer::init()
{
...
enum SetResponse rptSalesHistoryByCustomer::set(ParameterList &pParams)
{
  QVariant param;
  bool     valid;
...
void rptSalesHistoryByCustomer::sPrint()
{
  if (!_dates->allValid())
  {
