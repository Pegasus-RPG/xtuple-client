...
/*
 *  Constructs a rptSlowMovingInventoryByClassCode as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSlowMovingInventoryByClassCode::rptSlowMovingInventoryByClassCode(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSlowMovingInventoryByClassCode::~rptSlowMovingInventoryByClassCode()
{
 ...
 *  language.
 */
void rptSlowMovingInventoryByClassCode::languageChange()
{
    retranslateUi(this);
}


void rptSlowMovingInventoryByClassCode::init()
{
  _captive = FALSE;
...
enum SetResponse rptSlowMovingInventoryByClassCode::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  param = pParams.value("cutoffDate", &valid);
  if (valid)
    _cutoffDate->setDate(param.toDate());
  ...
  _dateLastUsed->setChecked(pParams.inList("orderByDateLastUsed"));
...
void rptSlowMovingInventoryByClassCode::sPrint()
{
  if (!_cutoffDate->isValid())
  {
    QMessageBox::warning( this, tr("Invalid Cutoff Date"),
                          tr("Please enter in a valid Cutoff Date.") );
