...
class dspTimePhasedAvailableCapacityByWorkCenter : public QMainWindow, public Ui::dspTimePhasedAvailableCapacityByWorkCenter
{
    Q_OBJECT
...
public slots:
    ...
    virtual void sPopulateMenu( Q3PopupMenu * menu, Q3ListViewItem *, int pColumn );
