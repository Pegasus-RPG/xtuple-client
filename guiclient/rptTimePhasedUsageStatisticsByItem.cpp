...
/*
 *  Constructs a rptTimePhasedUsageStatisticsByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedUsageStatisticsByItem::rptTimePhasedUsageStatisticsByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedUsageStatisticsByItem::~rptTimePhasedUsageStatisticsByItem()
{
 ...
 *  language.
 */
void rptTimePhasedUsageStatisticsByItem::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedUsageStatisticsByItem::init()
{
  _captive = FALSE;
}

enum SetResponse rptTimePhasedUsageStatisticsByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptTimePhasedUsageStatisticsByItem::sPrint()
{
...
void rptTimePhasedUsageStatisticsByItem::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
...
ParameterList rptTimePhasedUsageStatisticsByItem::buildParameters()
{
