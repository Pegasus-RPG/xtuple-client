...
void dspWoScheduleByWorkOrder::sPostOperations()
{
  ParameterList params;
  params.append("wo_id", _wo->id());
...
void dspWoScheduleByWorkOrder::sViewWooper()
{
  ParameterList params;
  params.append("wo_id", _wo->id());
  params.append("run");
...
void dspWoScheduleByWorkOrder::sDspWoEffortByWorkOrder()
{
  ParameterList params;
  params.append("wo_id", _wo->id());
  params.append("run");
...
void dspWoScheduleByWorkOrder::sViewBOO()
{
  q.prepare("SELECT itemsite_item_id FROM itemsite WHERE (itemsite_id=:id);");
  q.bindValue(":id", _wo->altId());
  q.exec();
