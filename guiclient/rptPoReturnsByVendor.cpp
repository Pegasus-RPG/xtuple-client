...
/*
 *  Constructs a rptPoReturnsByVendor as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptPoReturnsByVendor::rptPoReturnsByVendor(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptPoReturnsByVendor::~rptPoReturnsByVendor()
{
 ...
 *  language.
 */
void rptPoReturnsByVendor::languageChange()
{
    retranslateUi(this);
}


void rptPoReturnsByVendor::init()
{
  _captive = FALSE;
...
enum SetResponse rptPoReturnsByVendor::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptPoReturnsByVendor::sPrint()
{
  if(!_dates->allValid()) {
