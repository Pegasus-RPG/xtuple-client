...
/*
 *  Constructs a rptPoPriceVariancesByVendor as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptPoPriceVariancesByVendor::rptPoPriceVariancesByVendor(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptPoPriceVariancesByVendor::~rptPoPriceVariancesByVendor()
{
 ...
 *  language.
 */
void rptPoPriceVariancesByVendor::languageChange()
{
    retranslateUi(this);
}


void rptPoPriceVariancesByVendor::init()
{
...
enum SetResponse rptPoPriceVariancesByVendor::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptPoPriceVariancesByVendor::sPrint()
{
  if (!_dates->allValid())
  {
