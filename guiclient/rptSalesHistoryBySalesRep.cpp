...
/*
 *  Constructs a rptSalesHistoryBySalesRep as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSalesHistoryBySalesRep::rptSalesHistoryBySalesRep(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSalesHistoryBySalesRep::~rptSalesHistoryBySalesRep()
{
 ...
 *  language.
 */
void rptSalesHistoryBySalesRep::languageChange()
{
    retranslateUi(this);
}


void rptSalesHistoryBySalesRep::init()
{
...
enum SetResponse rptSalesHistoryBySalesRep::set(ParameterList &pParams)
{
  QVariant param;
  bool     valid;
...
void rptSalesHistoryBySalesRep::sPrint()
{
  if (!_dates->allValid())
  {
