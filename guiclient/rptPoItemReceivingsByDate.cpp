...
/*
 *  Constructs a rptPoItemReceivingsByDate as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptPoItemReceivingsByDate::rptPoItemReceivingsByDate(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptPoItemReceivingsByDate::~rptPoItemReceivingsByDate()
{
 ...
 *  language.
 */
void rptPoItemReceivingsByDate::languageChange()
{
    retranslateUi(this);
}


void rptPoItemReceivingsByDate::init()
{
...
enum SetResponse rptPoItemReceivingsByDate::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptPoItemReceivingsByDate::sPrint()
{
  if (!_dates->allValid())
  {
