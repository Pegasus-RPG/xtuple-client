...
/*
 *  Constructs a rptPoItemsByDate as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptPoItemsByDate::rptPoItemsByDate(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptPoItemsByDate::~rptPoItemsByDate()
{
 ...
 *  language.
 */
void rptPoItemsByDate::languageChange()
{
    retranslateUi(this);
}


void rptPoItemsByDate::init()
{
...
enum SetResponse rptPoItemsByDate::set(ParameterList &pParams)
{
  _captive = TRUE;
