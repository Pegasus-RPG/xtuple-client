...
class standardJournalGroups : public QMainWindow, public Ui::standardJournalGroups
{
    Q_OBJECT

public:
    standardJournalGroups(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
