...
#ifndef USEREVENTNOTIFICATION_H
#define USEREVENTNOTIFICATION_H

#include "OpenMFGGUIClient.h"
#include <QtGui/QDialog>
#include <QtGui/QWidget>
#include <parameter.h>
#include "ui_userEventNotification.h"

class userEventNotification : public QDialog, public Ui::userEventNotification
{
    Q_OBJECT
