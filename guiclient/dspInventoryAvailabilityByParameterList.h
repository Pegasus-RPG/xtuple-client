...
class dspInventoryAvailabilityByParameterList : public QMainWindow, public Ui::dspInventoryAvailabilityByParameterList
{
    Q_OBJECT

public:
    dspInventoryAvailabilityByParameterList(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
