...
class dspPoItemReceivingsByDate : public QMainWindow, public Ui::dspPoItemReceivingsByDate
{
    Q_OBJECT

public:
    dspPoItemReceivingsByDate(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
