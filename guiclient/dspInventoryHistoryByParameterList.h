...
class dspInventoryHistoryByParameterList : public QMainWindow, public Ui::dspInventoryHistoryByParameterList
{
    Q_OBJECT

public:
    dspInventoryHistoryByParameterList(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
