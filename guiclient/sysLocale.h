...
class sysLocale : public QDialog, public Ui::sysLocale
{
    Q_OBJECT
...
public slots:
    ...
    virtual void sSave();
    virtual void sClose();
    virtual void sBuildDate();
    virtual void sBuildTime();
    virtual void sBuildTimestamp();
    virtual void sBuildInterval();
