...
/*
 *  Constructs a rptInventoryAvailabilityByParameterList as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptInventoryAvailabilityByParameterList::rptInventoryAvailabilityByParameterList(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptInventoryAvailabilityByParameterList::~rptInventoryAvailabilityByParameterList()
{
 ...
 *  language.
 */
void rptInventoryAvailabilityByParameterList::languageChange()
{
    retranslateUi(this);
}


void rptInventoryAvailabilityByParameterList::init()
{
  _captive = FALSE;
}

enum SetResponse rptInventoryAvailabilityByParameterList::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  param = pParams.value("byRange", &valid);
  if (valid)
...
void rptInventoryAvailabilityByParameterList::sPrint()
{
