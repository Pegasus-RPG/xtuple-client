...
/*
 *  Constructs a rptSummarizedBacklogByWarehouse as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSummarizedBacklogByWarehouse::rptSummarizedBacklogByWarehouse(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSummarizedBacklogByWarehouse::~rptSummarizedBacklogByWarehouse()
{
 ...
 *  language.
 */
void rptSummarizedBacklogByWarehouse::languageChange()
{
    retranslateUi(this);
}


void rptSummarizedBacklogByWarehouse::init()
{
...
enum SetResponse rptSummarizedBacklogByWarehouse::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  _shipDate->setChecked(pParams.inList("orderByShipDate"));
  _packDate->setChecked(pParams.inList("orderByPackDate"));
  _orderNumber->setChecked(pParams.inList("orderByOrderNumber"));
...
void rptSummarizedBacklogByWarehouse::sPrint()
{
