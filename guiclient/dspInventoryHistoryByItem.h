...
class dspInventoryHistoryByItem : public QMainWindow, public Ui::dspInventoryHistoryByItem
{
    Q_OBJECT

public:
    dspInventoryHistoryByItem(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
