...
class dspBacklogByCustomer : public QMainWindow, public Ui::dspBacklogByCustomer
{
    Q_OBJECT

public:
    dspBacklogByCustomer(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
