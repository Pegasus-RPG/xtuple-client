...
#ifndef DSPBREEDERDISTRIBUTIONVARIANCEBYITEM_H
...
class dspBreederDistributionVarianceByItem : public QMainWindow, public Ui::dspBreederDistributionVarianceByItem
{
    Q_OBJECT
...
#endif // DSPBREEDERDISTRIBUTIONVARIANCEBYITEM_H
