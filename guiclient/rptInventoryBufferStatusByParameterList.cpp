...
/*
 *  Constructs a rptInventoryBufferStatusByParameterList as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptInventoryBufferStatusByParameterList::rptInventoryBufferStatusByParameterList(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptInventoryBufferStatusByParameterList::~rptInventoryBufferStatusByParameterList()
{
 ...
 *  language.
 */
void rptInventoryBufferStatusByParameterList::languageChange()
{
    retranslateUi(this);
}

enum SetResponse rptInventoryBufferStatusByParameterList::set(const ParameterList &pParams)
{
  _captive = TRUE;
  ...
  _GreaterThanZero->setChecked(pParams.inList("GreaterThanZero"));

  param = pParams.value("GreaterThanZero", &valid);
  if (valid)
  {
    _GreaterThanZero->setChecked(TRUE);
  }

  param = pParams.value("EmergencyZone", &valid);
  if (valid)
  {
    _EmergencyZone->setChecked(TRUE);
  }

  param = pParams.value("All", &valid);
  if (valid)
  {
...
void rptInventoryBufferStatusByParameterList::sPrint()
{
