...
class currencyConversions : public QMainWindow, public Ui::currencyConversions
{
    Q_OBJECT

public:
    currencyConversions(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
    ~currencyConversions();
