...
/*
 *  Constructs a rptBOOItemsByWorkCenter as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptBOOItemsByWorkCenter::rptBOOItemsByWorkCenter(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptBOOItemsByWorkCenter::~rptBOOItemsByWorkCenter()
{
 ...
 *  language.
 */
void rptBOOItemsByWorkCenter::languageChange()
{
    retranslateUi(this);
}


void rptBOOItemsByWorkCenter::init()
{
  _captive = FALSE;
...
enum SetResponse rptBOOItemsByWorkCenter::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptBOOItemsByWorkCenter::sPopulate()
{
...
void rptBOOItemsByWorkCenter::sPrint()
{
