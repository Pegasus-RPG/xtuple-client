...
/*
 *  Constructs a rptMRPDetail as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptMRPDetail::rptMRPDetail(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 *  language.
 */
void rptMRPDetail::languageChange()
{
    retranslateUi(this);
}


void rptMRPDetail::init()
{
  _captive = FALSE;
...
enum SetResponse rptMRPDetail::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptMRPDetail::sFillItemsites()
{
  QString sql( "SELECT itemsite_id, item_number, (item_descrip1 || ' ' || item_descrip2),"
               "       warehous_code "
