...
/*
 *  Constructs a rptARAging as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptARAging::rptARAging(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 *  language.
 */
void rptARAging::languageChange()
{
    retranslateUi(this);
}


void rptARAging::init()
{
  _captive = FALSE;
...
enum SetResponse rptARAging::set(const ParameterList & pParams)
{
  _captive = TRUE;
...
void rptARAging::sPrint()
{
  ParameterList params;
  params.append("calhead_id", _calendar->id());
  params.append("relDate", _date->date());;
  params.append("offset", omfgThis->dbDate().daysTo(_date->date()));
...
void rptARAging::sCalendarSelected( int id )
{
