...
class dspItemSourcesByItem : public QMainWindow, public Ui::dspItemSourcesByItem
{
    Q_OBJECT

public:
    dspItemSourcesByItem(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
