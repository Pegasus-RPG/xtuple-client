...
class dspSummarizedBacklogByWarehouse : public QMainWindow, public Ui::dspSummarizedBacklogByWarehouse
{
    Q_OBJECT

public:
    dspSummarizedBacklogByWarehouse(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
