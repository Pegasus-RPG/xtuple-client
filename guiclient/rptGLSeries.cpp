...
/*
 *  Constructs a rptGLSeries as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptGLSeries::rptGLSeries(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 *  language.
 */
void rptGLSeries::languageChange()
{
    retranslateUi(this);
}


void rptGLSeries::init()
{
  _captive = FALSE;
}

enum SetResponse rptGLSeries::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  param = pParams.value("startJrnlnum", &valid);
  if (valid)
  {
  ...
  param = pParams.value("endJrnlnum", &valid);
  if (valid)
  {
    _jrnlGroup->setChecked(TRUE);
