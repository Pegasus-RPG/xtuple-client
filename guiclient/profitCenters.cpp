    ...
    : QMainWindow(parent, name, fl)
{
    ...
    connect(_prftcntr, SIGNAL(populateMenu(Q3PopupMenu *, Q3ListViewItem *, int)), this, SLOT(sPopulateMenu(Q3PopupMenu*)));
...
void profitCenters::sPopulateMenu(Q3PopupMenu *pMenu)
{
  int menuItem;
