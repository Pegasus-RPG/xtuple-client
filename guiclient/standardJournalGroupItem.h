...
class standardJournalGroupItem : public QDialog, public Ui::standardJournalGroupItem
{
    Q_OBJECT

public:
    standardJournalGroupItem(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WFlags fl = 0);
