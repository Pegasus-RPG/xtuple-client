...
/*
 *  Constructs a rptWoBufferStatusByParameterList as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptWoBufferStatusByParameterList::rptWoBufferStatusByParameterList(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptWoBufferStatusByParameterList::~rptWoBufferStatusByParameterList()
{
 ...
 *  language.
 */
void rptWoBufferStatusByParameterList::languageChange()
{
    retranslateUi(this);
}

enum SetResponse rptWoBufferStatusByParameterList::set(const ParameterList &pParams)
{
  _captive = TRUE;
  ...
  {
    case ClassCode:
      setCaption(tr("Report Parameters - W/O Buffer Status by Class Code"));
      break;

    case PlannerCode:
      setCaption(tr("Report Parameters - W/O Buffer Status by Planner Code"));
      break;

    case ItemGroup:
      setCaption(tr("Report Parameters - W/O Buffer Status by Item Group"));
      break;
...
void rptWoBufferStatusByParameterList::sPrint()
{
