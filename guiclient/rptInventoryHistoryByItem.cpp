...
/*
 *  Constructs a rptInventoryHistoryByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptInventoryHistoryByItem::rptInventoryHistoryByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptInventoryHistoryByItem::~rptInventoryHistoryByItem()
{
 ...
 *  language.
 */
void rptInventoryHistoryByItem::languageChange()
{
    retranslateUi(this);
}


void rptInventoryHistoryByItem::init()
{
  _captive = FALSE;
...
enum SetResponse rptInventoryHistoryByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptInventoryHistoryByItem::sPrint()
{
  if (!_dates->allValid())
  {
