...
class dspSummarizedSalesByCustomerTypeByItem : public QMainWindow, public Ui::dspSummarizedSalesByCustomerTypeByItem
{
    Q_OBJECT

public:
    dspSummarizedSalesByCustomerTypeByItem(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
