...
#ifndef DSPSALESHISTORYBYPARAMETERLIST_H
...
class dspSalesHistoryByParameterList : public QMainWindow, public Ui::dspSalesHistoryByParameterList
{
    Q_OBJECT
...
#endif // DSPSALESHISTORYBYPARAMETERLIST_H
