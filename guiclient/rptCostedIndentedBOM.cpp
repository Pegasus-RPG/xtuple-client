...
/*
 *  Constructs a rptCostedIndentedBOM as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptCostedIndentedBOM::rptCostedIndentedBOM(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptCostedIndentedBOM::~rptCostedIndentedBOM()
{
 ...
 *  language.
 */
void rptCostedIndentedBOM::languageChange()
{
    retranslateUi(this);
}


void rptCostedIndentedBOM::init()
{
  _captive = FALSE;
...
enum SetResponse rptCostedIndentedBOM::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptCostedIndentedBOM::sPrint()
{
