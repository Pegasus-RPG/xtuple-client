...
/*
 *  Constructs a rptTimePhasedBookingsByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedBookingsByItem::rptTimePhasedBookingsByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedBookingsByItem::~rptTimePhasedBookingsByItem()
{
 ...
 *  language.
 */
void rptTimePhasedBookingsByItem::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedBookingsByItem::init()
{
  _productCategory->setType(ProductCategory);
}

enum SetResponse rptTimePhasedBookingsByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  param = pParams.value("inventoryUnits", &valid);
  if (valid)
    _inventoryUnits->setChecked(TRUE);

  param = pParams.value("salesDollars", &valid);
  if (valid)
    _salesDollars->setChecked(TRUE);
...
void rptTimePhasedBookingsByItem::sPrint()
{
...
void rptTimePhasedBookingsByItem::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
...
ParameterList rptTimePhasedBookingsByItem::buildParameters()
{
