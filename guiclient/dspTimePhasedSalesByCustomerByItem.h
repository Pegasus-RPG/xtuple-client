...
class dspTimePhasedSalesByCustomerByItem : public XMainWindow, public Ui::dspTimePhasedSalesByCustomerByItem
{
    Q_OBJECT

public:
    dspTimePhasedSalesByCustomerByItem(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
