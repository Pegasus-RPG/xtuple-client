...
/*
 *  Constructs a rptSummarizedTaxableSales as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSummarizedTaxableSales::rptSummarizedTaxableSales(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSummarizedTaxableSales::~rptSummarizedTaxableSales()
{
 ...
 *  language.
 */
void rptSummarizedTaxableSales::languageChange()
{
    retranslateUi(this);
}


void rptSummarizedTaxableSales::init()
{
  _captive = TRUE;
...
enum SetResponse rptSummarizedTaxableSales::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  if (valid)
  {
    _selectedTaxCode->setChecked(TRUE);
...
void rptSummarizedTaxableSales::sPrint()
{
