...
class dspDetailedInventoryHistoryByLotSerial : public QMainWindow, public Ui::dspDetailedInventoryHistoryByLotSerial
{
    Q_OBJECT

public:
    dspDetailedInventoryHistoryByLotSerial(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
