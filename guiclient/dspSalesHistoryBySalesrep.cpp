...
void dspSalesHistoryBySalesrep::sPopulateMenu(Q3PopupMenu *pMenu)
{
  int menuItem;
...
void dspSalesHistoryBySalesrep::sFillList()
{
  ...
  if (q.first())
  {
    ...
    if (_showCosts->isChecked())
      totals->setText(10, formatMoney(totalCosts));
  }
}
