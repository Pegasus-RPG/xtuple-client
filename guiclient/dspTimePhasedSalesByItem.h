...
class dspTimePhasedSalesByItem : public QMainWindow, public Ui::dspTimePhasedSalesByItem
{
    Q_OBJECT

public:
    dspTimePhasedSalesByItem(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
