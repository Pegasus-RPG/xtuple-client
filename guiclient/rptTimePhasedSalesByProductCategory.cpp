...
/*
 *  Constructs a rptTimePhasedSalesByProductCategory as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedSalesByProductCategory::rptTimePhasedSalesByProductCategory(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedSalesByProductCategory::~rptTimePhasedSalesByProductCategory()
{
 ...
 *  language.
 */
void rptTimePhasedSalesByProductCategory::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedSalesByProductCategory::init()
{
...
enum SetResponse rptTimePhasedSalesByProductCategory::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptTimePhasedSalesByProductCategory::sPrint()
{
...
void rptTimePhasedSalesByProductCategory::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
...
ParameterList rptTimePhasedSalesByProductCategory::buildParameters()
{
