 ...
 */
rptCustomerInformation::~rptCustomerInformation()
{
 ...
 *  language.
 */
void rptCustomerInformation::languageChange()
{
    retranslateUi(this);
}


void rptCustomerInformation::init()
{
#ifdef Q_WS_MAC
...
enum SetResponse rptCustomerInformation::set( const ParameterList & pParams )
{
  _captive = TRUE;
  ...
  param = pParams.value("print", &valid);
  if (valid)
  {
    sPrint();
...
void rptCustomerInformation::sPrint()
{
