...
class dspBriefSalesHistoryBySalesRep : public QMainWindow, public Ui::dspBriefSalesHistoryBySalesRep
{
    Q_OBJECT

public:
    dspBriefSalesHistoryBySalesRep(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
