...
void dspBookingsByProductCategory::init()
{
  statusBar()->hide();
...
enum SetResponse dspBookingsByProductCategory::set(ParameterList &pParams)
{
  QVariant param;
  bool     valid;
...
void dspBookingsByProductCategory::sPrint()
{
  ...
  rptBookingsByProductCategory newdlg(this, "", TRUE);
  newdlg.set(params);
}
