...
class QNetworkAccessManagerProto : public QObject, public QScriptable
{
  ...
  public:
    ...
    Q_INVOKABLE void               setProxy(const QNetworkProxy &proxy) const;
    Q_INVOKABLE QString            toString() const;

    // TODO: why do we need these instead of getting them from QNetworkAccessManager?
    // see constructQNetworkAccessManager
  /*
  signals:
