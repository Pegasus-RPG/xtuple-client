...
class dspSummarizedSalesByCustomerType : public QMainWindow, public Ui::dspSummarizedSalesByCustomerType
{
    Q_OBJECT

public:
    dspSummarizedSalesByCustomerType(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
