...
class dspTimePhasedBookingsByProductCategory : public QMainWindow, public Ui::dspTimePhasedBookingsByProductCategory
{
    Q_OBJECT

public:
    dspTimePhasedBookingsByProductCategory(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
