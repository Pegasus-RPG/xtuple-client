...
/*
 *  Constructs a rptBriefEarnedCommissions as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptBriefEarnedCommissions::rptBriefEarnedCommissions(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptBriefEarnedCommissions::~rptBriefEarnedCommissions()
{
 ...
 *  language.
 */
void rptBriefEarnedCommissions::languageChange()
{
    retranslateUi(this);
}


void rptBriefEarnedCommissions::init()
{
  _salesrep->setType(XComboBox::SalesReps);
}

enum SetResponse rptBriefEarnedCommissions::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  if (valid)
  {
    _selectedSalesrep->setChecked(TRUE);
...
void rptBriefEarnedCommissions::sPrint()
{
  if (!_dates->allValid())
  {
