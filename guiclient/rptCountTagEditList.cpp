...
/*
 *  Constructs a rptCountTagEditList as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptCountTagEditList::rptCountTagEditList(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptCountTagEditList::~rptCountTagEditList()
{
 ...
 *  language.
 */
void rptCountTagEditList::languageChange()
{
    retranslateUi(this);
}


void rptCountTagEditList::init()
{
  _captive = TRUE;
...
enum SetResponse rptCountTagEditList::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  param = pParams.value("ParameterType", &valid);
  if ( (valid) && (param.toString() == "ClassCode") )
  {
    _parameter->setType(ClassCode);
  ...
  else if ( (valid) && (param.toString() == "PlannerCode") )
  {
...
void rptCountTagEditList::sPrint()
{
  ParameterList params;
  _parameter->appendValue(params);
  _warehouse->appendValue(params);

  params.append("maxTags", _maxTags->value());
...
void rptCountTagEditList::sParameterTypeChanged()
{
