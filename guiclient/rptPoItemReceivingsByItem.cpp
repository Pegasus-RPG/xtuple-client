...
/*
 *  Constructs a rptPoItemReceivingsByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptPoItemReceivingsByItem::rptPoItemReceivingsByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptPoItemReceivingsByItem::~rptPoItemReceivingsByItem()
{
 ...
 *  language.
 */
void rptPoItemReceivingsByItem::languageChange()
{
    retranslateUi(this);
}


void rptPoItemReceivingsByItem::init()
{
  _captive = FALSE;
...
enum SetResponse rptPoItemReceivingsByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptPoItemReceivingsByItem::sPrint()
{
  if (!_item->isValid())
  {
