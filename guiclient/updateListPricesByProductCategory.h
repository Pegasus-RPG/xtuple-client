...
class updateListPricesByProductCategory : public QDialog, public Ui::updateListPricesByProductCategory
{
    Q_OBJECT

public:
    updateListPricesByProductCategory(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WFlags fl = 0);
