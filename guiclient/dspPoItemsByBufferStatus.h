...
#ifndef DSPPOITEMSBYBUFFERSTATUSBU_H
...
class dspPoItemsByBufferStatus : public QMainWindow, public Ui::dspPoItemsByBufferStatus
{
    Q_OBJECT
...
#endif // DSPPOITEMSBYBUFFERSTATUSBU_H
