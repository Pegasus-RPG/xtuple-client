...
/*
 *  Constructs a rptTimePhasedBookingsByProductCategory as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedBookingsByProductCategory::rptTimePhasedBookingsByProductCategory(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedBookingsByProductCategory::~rptTimePhasedBookingsByProductCategory()
{
 ...
 *  language.
 */
void rptTimePhasedBookingsByProductCategory::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedBookingsByProductCategory::init()
{
...
void rptTimePhasedBookingsByProductCategory::sPrint()
{
...
void rptTimePhasedBookingsByProductCategory::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
