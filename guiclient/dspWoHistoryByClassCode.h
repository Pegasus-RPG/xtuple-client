...
class dspWoHistoryByClassCode : public QMainWindow, public Ui::dspWoHistoryByClassCode
{
    Q_OBJECT

public:
    dspWoHistoryByClassCode(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
