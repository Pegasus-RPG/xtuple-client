...
/*
 *  Constructs a rptSubstituteAvailabilityByRootItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSubstituteAvailabilityByRootItem::rptSubstituteAvailabilityByRootItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSubstituteAvailabilityByRootItem::~rptSubstituteAvailabilityByRootItem()
{
 ...
 *  language.
 */
void rptSubstituteAvailabilityByRootItem::languageChange()
{
    retranslateUi(this);
}


void rptSubstituteAvailabilityByRootItem::init()
{
  _captive = FALSE;
}

enum SetResponse rptSubstituteAvailabilityByRootItem::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptSubstituteAvailabilityByRootItem::sPrint()
{
