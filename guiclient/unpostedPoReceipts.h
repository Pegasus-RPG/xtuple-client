...
class unpostedPoReceipts : public QMainWindow, public Ui::unpostedPoReceipts
{
    Q_OBJECT

public:
    unpostedPoReceipts(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
    ~unpostedPoReceipts();
