...
class maintainItemCosts : public QMainWindow, public Ui::maintainItemCosts
{
    Q_OBJECT

public:
    maintainItemCosts(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
    ~maintainItemCosts();
