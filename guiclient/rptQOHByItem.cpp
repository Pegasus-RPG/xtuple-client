...
/*
 *  Constructs a rptQOHByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptQOHByItem::rptQOHByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 *  language.
 */
void rptQOHByItem::languageChange()
{
    retranslateUi(this);
}


void rptQOHByItem::init()
{
...
enum SetResponse rptQOHByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
