...
class dspMaterialUsageVarianceByWarehouse : public QMainWindow, public Ui::dspMaterialUsageVarianceByWarehouse
{
    Q_OBJECT

public:
    dspMaterialUsageVarianceByWarehouse(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
