...
/*
 *  Constructs a rptPoPriceVariancesByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptPoPriceVariancesByItem::rptPoPriceVariancesByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptPoPriceVariancesByItem::~rptPoPriceVariancesByItem()
{
 ...
 *  language.
 */
void rptPoPriceVariancesByItem::languageChange()
{
    retranslateUi(this);
}


void rptPoPriceVariancesByItem::init()
{
  _captive = FALSE;
...
enum SetResponse rptPoPriceVariancesByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptPoPriceVariancesByItem::sPrint()
{
