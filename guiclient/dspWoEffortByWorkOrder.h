...
class dspWoEffortByWorkOrder : public QMainWindow, public Ui::dspWoEffortByWorkOrder
{
    Q_OBJECT

public:
    dspWoEffortByWorkOrder(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
