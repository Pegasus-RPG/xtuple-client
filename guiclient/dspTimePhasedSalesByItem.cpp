...
void dspTimePhasedSalesByItem::sPopulateMenu(Q3PopupMenu *menuThis, Q3ListViewItem *, int pColumn)
{
  int menuItem;
...
void dspTimePhasedSalesByItem::sCalculate()
{
  ...
  if (q.first())
  {
    ...
    do
    {
      XListViewItem *item = new XListViewItem( _sohist, _sohist->lastItem(), q.value("itemsite_id").toInt(),
