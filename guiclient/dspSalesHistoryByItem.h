...
class dspSalesHistoryByItem : public XMainWindow, public Ui::dspSalesHistoryByItem
{
    Q_OBJECT

public:
    dspSalesHistoryByItem(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
