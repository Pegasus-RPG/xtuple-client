...
class accountingYearPeriod : public QDialog, public Ui::accountingYearPeriod
{
    Q_OBJECT

public:
    accountingYearPeriod(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WFlags fl = 0);
