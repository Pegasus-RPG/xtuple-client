...
/*
 *  Constructs a rptBacklogByParameterList as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptBacklogByParameterList::rptBacklogByParameterList(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptBacklogByParameterList::~rptBacklogByParameterList()
{
 ...
 *  language.
 */
void rptBacklogByParameterList::languageChange()
{
    retranslateUi(this);
}


void rptBacklogByParameterList::init()
{
  _dates->setStartNull(tr("Earliest"), omfgThis->startOfTime(), TRUE);
  _dates->setEndNull(tr("Latest"), omfgThis->endOfTime(), TRUE);

  _showPrices->setChecked( (_privleges->check("ViewCustomerPrices")) || (_privleges->check("MaintainCustomerPrices")) );
  _showPrices->setEnabled( (_privleges->check("ViewCustomerPrices")) || (_privleges->check("MaintainCustomerPrices")) );
}

enum SetResponse rptBacklogByParameterList::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  {
    case CustomerType:
      setCaption(tr("Report Parameters - Backlog by Customer Type"));
      break;

    case CustomerGroup:
      setCaption(tr("Report Parameters - Backlog by Customer Group"));
      break;

    case ProductCategory:
      setCaption(tr("Report Parameters - Backlog by Parameter List"));
      break;
...
void rptBacklogByParameterList::sPrint()
{
