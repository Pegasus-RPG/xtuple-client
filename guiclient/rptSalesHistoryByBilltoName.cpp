...
/*
 *  Constructs a rptSalesHistoryByBilltoName as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSalesHistoryByBilltoName::rptSalesHistoryByBilltoName(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSalesHistoryByBilltoName::~rptSalesHistoryByBilltoName()
{
 ...
 *  language.
 */
void rptSalesHistoryByBilltoName::languageChange()
{
  retranslateUi(this);
}
...
bool rptSalesHistoryByBilltoName::checkParameters()
{
  if (isVisible())
  {
    if (!_dates->allValid())
