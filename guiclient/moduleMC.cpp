...
void moduleMC::sNewCurrency()
{
  ParameterList params;
  params.append("mode", "new");

  currency newdlg(omfgThis, "", TRUE);
  newdlg.set(params);
  newdlg.exec();
}

void moduleMC::sCurrencies()
{
  omfgThis->handleNewWindow(new currencies());
}

void moduleMC::sPostExchangeRate()
{
  postExchangeRate newdlg(omfgThis, "", TRUE);
  newdlg.exec();
}

void moduleMC::sNewExchangeRateSet()
{
}

void moduleMC::sUnpostedExchangeRateSet()
{
}

void moduleMC::sPostExchangeRateSet()
{
}

void moduleMC::sDspNormalizedTPOpenAPItems()
{
}

void moduleMC::sDspNormalizedTPOpenARItems()
{
}

void moduleMC::sRptNormalizedTPOpenAPItems()
{
}

void moduleMC::sRptNormalizedTPOpenARItems()
{
}
