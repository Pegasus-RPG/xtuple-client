...
/*
 *  Constructs a rptInventoryAvailabilityBySalesOrder as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptInventoryAvailabilityBySalesOrder::rptInventoryAvailabilityBySalesOrder(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptInventoryAvailabilityBySalesOrder::~rptInventoryAvailabilityBySalesOrder()
{
 ...
 *  language.
 */
void rptInventoryAvailabilityBySalesOrder::languageChange()
{
    retranslateUi(this);
}

enum SetResponse rptInventoryAvailabilityBySalesOrder::set(const ParameterList &pParams)
{
  _captive = TRUE;
...
void rptInventoryAvailabilityBySalesOrder::sSoList()
{
...
void rptInventoryAvailabilityBySalesOrder::sPrint()
{
  ParameterList params;
...
void rptInventoryAvailabilityBySalesOrder::sPopulateSoInfo(int)
{
  if (_so->id() != -1)
  {
