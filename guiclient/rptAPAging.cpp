...
/*
 *  Constructs a rptAPAging as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptAPAging::rptAPAging(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 *  language.
 */
void rptAPAging::languageChange()
{
    retranslateUi(this);
}

enum SetResponse rptAPAging::set(const ParameterList & pParams)
{
  _captive = TRUE;
...
void rptAPAging::sCalendarSelected( int id )
{
