...
class dspTimePhasedSalesByCustomer : public QMainWindow, public Ui::dspTimePhasedSalesByCustomer
{
    Q_OBJECT

public:
    dspTimePhasedSalesByCustomer(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
