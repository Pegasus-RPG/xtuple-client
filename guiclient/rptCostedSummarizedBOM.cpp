 ...
 */
rptCostedSummarizedBOM::~rptCostedSummarizedBOM()
{
 ...
 *  language.
 */
void rptCostedSummarizedBOM::languageChange()
{
    retranslateUi(this);
}

enum SetResponse rptCostedSummarizedBOM::set(const ParameterList &pParams)
{
  QVariant param;
  bool     valid;
...
void rptCostedSummarizedBOM::sPrint()
{
