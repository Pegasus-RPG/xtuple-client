...
class accountingPeriods : public QMainWindow, public Ui::accountingPeriods
{
    Q_OBJECT

public:
    accountingPeriods(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
    ~accountingPeriods();
