...
/*
 *  Constructs a apAccountAssignment as a child of 'parent', with the
...
void apAccountAssignment::init()
{
  _vendorTypes->setType(XComboBox::VendorTypes);
}

enum SetResponse apAccountAssignment::set(ParameterList &pParams)
{
  QVariant param;
  bool     valid;
