...
class reconcileBankaccount : public QMainWindow, public Ui::reconcileBankaccount
{
    Q_OBJECT

public:
    reconcileBankaccount(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
