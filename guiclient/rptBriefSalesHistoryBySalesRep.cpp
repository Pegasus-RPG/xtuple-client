...
/*
 *  Constructs a rptBriefSalesHistoryBySalesRep as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptBriefSalesHistoryBySalesRep::rptBriefSalesHistoryBySalesRep(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptBriefSalesHistoryBySalesRep::~rptBriefSalesHistoryBySalesRep()
{
 ...
 *  language.
 */
void rptBriefSalesHistoryBySalesRep::languageChange()
{
    retranslateUi(this);
}


void rptBriefSalesHistoryBySalesRep::init()
{
...
enum SetResponse rptBriefSalesHistoryBySalesRep::set(ParameterList &pParams)
{
  QVariant param;
  bool     valid;
...
void rptBriefSalesHistoryBySalesRep::sPrint()
{
  if (!_dates->allValid())
  {
