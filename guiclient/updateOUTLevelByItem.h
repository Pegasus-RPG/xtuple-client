...
class updateOUTLevelByItem : public QDialog, public Ui::updateOUTLevelByItem
{
    Q_OBJECT

public:
    updateOUTLevelByItem(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WFlags fl = 0);
