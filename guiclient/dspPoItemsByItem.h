...
class dspPoItemsByItem : public QMainWindow, public Ui::dspPoItemsByItem
{
    Q_OBJECT

public:
    dspPoItemsByItem(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
    ~dspPoItemsByItem();
