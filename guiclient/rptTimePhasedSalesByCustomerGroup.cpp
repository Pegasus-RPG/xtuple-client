...
/*
 *  Constructs a rptTimePhasedSalesByCustomerGroup as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedSalesByCustomerGroup::rptTimePhasedSalesByCustomerGroup(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedSalesByCustomerGroup::~rptTimePhasedSalesByCustomerGroup()
{
 ...
 *  language.
 */
void rptTimePhasedSalesByCustomerGroup::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedSalesByCustomerGroup::init()
{
  _captive = FALSE;
...
enum SetResponse rptTimePhasedSalesByCustomerGroup::set(ParameterList &pParams)
{
  QVariant param;
  bool     valid;
...
void rptTimePhasedSalesByCustomerGroup::sPrint()
{
