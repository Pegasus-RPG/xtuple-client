...
/*
 *  Constructs a rptPoItemsByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptPoItemsByItem::rptPoItemsByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptPoItemsByItem::~rptPoItemsByItem()
{
 ...
 *  language.
 */
void rptPoItemsByItem::languageChange()
{
    retranslateUi(this);
}


void rptPoItemsByItem::init()
{
  _agent->setType(XComboBox::Agent);
  _agent->setText(omfgThis->username());
}

enum SetResponse rptPoItemsByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
