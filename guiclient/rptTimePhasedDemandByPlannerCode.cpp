...
/*
 *  Constructs a rptTimePhasedDemandByPlannerCode as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedDemandByPlannerCode::rptTimePhasedDemandByPlannerCode(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
    : QDialog(parent, name, modal, fl)
{
  setupUi(this);

  QButtonGroup* btngrpDisplayUnitsInt = new QButtonGroup(this);
  btngrpDisplayUnitsInt->addButton(_inventoryUnits);
  btngrpDisplayUnitsInt->addButton(_capacityUnits);
  btngrpDisplayUnitsInt->addButton(_altCapacityUnits);
 ...
 */
rptTimePhasedDemandByPlannerCode::~rptTimePhasedDemandByPlannerCode()
{
 ...
 *  language.
 */
void rptTimePhasedDemandByPlannerCode::languageChange()
{
    retranslateUi(this);
}


enum SetResponse rptTimePhasedDemandByPlannerCode::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptTimePhasedDemandByPlannerCode::sPrint()
{
...
void rptTimePhasedDemandByPlannerCode::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
...
ParameterList rptTimePhasedDemandByPlannerCode::buildParameters()
{
