...
/*
 *  Constructs a rptPoDeliveryDateVariancesByVendor as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptPoDeliveryDateVariancesByVendor::rptPoDeliveryDateVariancesByVendor(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptPoDeliveryDateVariancesByVendor::~rptPoDeliveryDateVariancesByVendor()
{
 ...
 *  language.
 */
void rptPoDeliveryDateVariancesByVendor::languageChange()
{
    retranslateUi(this);
}


void rptPoDeliveryDateVariancesByVendor::init()
{
...
enum SetResponse rptPoDeliveryDateVariancesByVendor::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptPoDeliveryDateVariancesByVendor::sPrint()
{
  if (!_dates->allValid())
  {
