...
/*
 *  Constructs a rptTimePhasedOpenARItems as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedOpenARItems::rptTimePhasedOpenARItems(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedOpenARItems::~rptTimePhasedOpenARItems()
{
 ...
 *  language.
 */
void rptTimePhasedOpenARItems::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedOpenARItems::init()
{
  _captive = FALSE;
...
enum SetResponse rptTimePhasedOpenARItems::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptTimePhasedOpenARItems::sPrint()
{
  if (_periods->isPeriodSelected())
  {
    orReport report("TimePhasedOpenARItems", buildParameters());
    if (report.isValid())
      report.print();
    else
    {
...
void rptTimePhasedOpenARItems::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
...
ParameterList rptTimePhasedOpenARItems::buildParameters()
{
