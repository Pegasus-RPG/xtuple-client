...
/*
 *  Constructs a rptPoDeliveryDateVariancesByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptPoDeliveryDateVariancesByItem::rptPoDeliveryDateVariancesByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptPoDeliveryDateVariancesByItem::~rptPoDeliveryDateVariancesByItem()
{
 ...
 *  language.
 */
void rptPoDeliveryDateVariancesByItem::languageChange()
{
    retranslateUi(this);
}


void rptPoDeliveryDateVariancesByItem::init()
{
...
enum SetResponse rptPoDeliveryDateVariancesByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptPoDeliveryDateVariancesByItem::sPrint()
{
  if (!_dates->allValid())
  {
