...
class reassignProductCategoryByProductCategory : public QDialog, public Ui::reassignProductCategoryByProductCategory
{
    Q_OBJECT

public:
    reassignProductCategoryByProductCategory(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WFlags fl = 0);
