...
/*
 *  Constructs a rptSummarizedSalesByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSummarizedSalesByItem::rptSummarizedSalesByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSummarizedSalesByItem::~rptSummarizedSalesByItem()
{
 ...
 *  language.
 */
void rptSummarizedSalesByItem::languageChange()
{
    retranslateUi(this);
}


void rptSummarizedSalesByItem::init()
{
  _productCategory->setType(ProductCategory);
  _customerType->setType(CustomerType);
}

enum SetResponse rptSummarizedSalesByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptSummarizedSalesByItem::sPrint()
{
