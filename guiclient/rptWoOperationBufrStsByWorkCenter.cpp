...
/*
 *  Constructs a rptWoOperationBufrStsByWorkCenter as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptWoOperationBufrStsByWorkCenter::rptWoOperationBufrStsByWorkCenter(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptWoOperationBufrStsByWorkCenter::~rptWoOperationBufrStsByWorkCenter()
{
 ...
 *  language.
 */
void rptWoOperationBufrStsByWorkCenter::languageChange()
{
    retranslateUi(this);
}


enum SetResponse rptWoOperationBufrStsByWorkCenter::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  _QtyAvailOnly->setChecked(pParams.inList("QtyAvailOnly"));
...
void rptWoOperationBufrStsByWorkCenter::sPopulate()
{
...
void rptWoOperationBufrStsByWorkCenter::sPrint()
{
