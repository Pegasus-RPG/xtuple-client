...
/*
 *  Constructs a rptIndentedBOM as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptIndentedBOM::rptIndentedBOM(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 *  language.
 */
void rptIndentedBOM::languageChange()
{
    retranslateUi(this);
}


void rptIndentedBOM::init()
{
  _captive = FALSE;
...
enum SetResponse rptIndentedBOM::set(ParameterList &pParams)
{
  _captive = TRUE;
