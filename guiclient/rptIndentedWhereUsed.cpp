...
/*
 *  Constructs a rptIndentedWhereUsed as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptIndentedWhereUsed::rptIndentedWhereUsed(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptIndentedWhereUsed::~rptIndentedWhereUsed()
{
 ...
 *  language.
 */
void rptIndentedWhereUsed::languageChange()
{
    retranslateUi(this);
}


void rptIndentedWhereUsed::init()
{
  _captive = FALSE;
...
enum SetResponse rptIndentedWhereUsed::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptIndentedWhereUsed::sPrint()
{
  if (!_item->isValid())
  {
