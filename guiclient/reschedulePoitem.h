...
#ifndef RESCHEDULEPOITEM_H
#define RESCHEDULEPOITEM_H

#include "guiclient.h"
#include "xdialog.h"
#include <parameter.h>
#include "ui_reschedulePoitem.h"

class reschedulePoitem : public XDialog, public Ui::reschedulePoitem
{
    Q_OBJECT
