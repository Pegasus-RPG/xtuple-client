...
/*
 *  Constructs a rptRoughCutByWorkCenter as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptRoughCutByWorkCenter::rptRoughCutByWorkCenter(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptRoughCutByWorkCenter::~rptRoughCutByWorkCenter()
{
 ...
 *  language.
 */
void rptRoughCutByWorkCenter::languageChange()
{
    retranslateUi(this);
}


void rptRoughCutByWorkCenter::init()
{
  _captive = FALSE;
...
enum SetResponse rptRoughCutByWorkCenter::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptRoughCutByWorkCenter::sPrint()
{
  if (!_dates->allValid())
  {
