...
/*
 *  Constructs a rptSalesHistoryByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSalesHistoryByItem::rptSalesHistoryByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSalesHistoryByItem::~rptSalesHistoryByItem()
{
 ...
 *  language.
 */
void rptSalesHistoryByItem::languageChange()
{
    retranslateUi(this);
}


void rptSalesHistoryByItem::init()
{
...
enum SetResponse rptSalesHistoryByItem::set(ParameterList &pParams)
{
  QVariant param;
  bool     valid;
...
void rptSalesHistoryByItem::sPrint()
{
  if (isVisible())
  {
    if (!_dates->allValid())
