...
class copyPurchaseOrder : public QDialog, public Ui::copyPurchaseOrder
{
    Q_OBJECT

public:
    copyPurchaseOrder(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WFlags fl = 0);
    ~copyPurchaseOrder();
