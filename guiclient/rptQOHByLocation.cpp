...
/*
 *  Constructs a rptQOHByLocation as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptQOHByLocation::rptQOHByLocation(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptQOHByLocation::~rptQOHByLocation()
{
 ...
 *  language.
 */
void rptQOHByLocation::languageChange()
{
    retranslateUi(this);
}


void rptQOHByLocation::init()
{
  _location->setAllowNull(TRUE);
  sPopulateLocations();
}

enum SetResponse rptQOHByLocation::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptQOHByLocation::sPrint()
{
  ...
  {
    QMessageBox::warning(this, tr("Invalid Location"), tr("A valid Location has not been selected.\nYou must select a valid Location before continuing.") );
    reject();
  }
}

void rptQOHByLocation::sPopulateLocations()
{
  if (_warehouse->isAll())
...
void rptQOHByLocation::sPopulateLocationInfo(int pLocationid)
{
  XSqlQuery location( QString( "SELECT formatBoolYN(location_netable) AS netable,"
