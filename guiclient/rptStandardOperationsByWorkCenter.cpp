...
/*
 *  Constructs a rptStandardOperationsByWorkCenter as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptStandardOperationsByWorkCenter::rptStandardOperationsByWorkCenter(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptStandardOperationsByWorkCenter::~rptStandardOperationsByWorkCenter()
{
 ...
 *  language.
 */
void rptStandardOperationsByWorkCenter::languageChange()
{
    retranslateUi(this);
}


void rptStandardOperationsByWorkCenter::init()
{
  _captive = FALSE;
...
enum SetResponse rptStandardOperationsByWorkCenter::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptStandardOperationsByWorkCenter::sPopulate()
{
...
void rptStandardOperationsByWorkCenter::sPrint()
{
