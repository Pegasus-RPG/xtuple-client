...
/*
 *  Constructs a rptBookingsByShipTo as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptBookingsByShipTo::rptBookingsByShipTo(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptBookingsByShipTo::~rptBookingsByShipTo()
{
 ...
 *  language.
 */
void rptBookingsByShipTo::languageChange()
{
    retranslateUi(this);
}

enum SetResponse rptBookingsByShipTo::set(const ParameterList &pParams)
{
  QVariant param;
  bool     valid;
...
void rptBookingsByShipTo::sPrint()
{
