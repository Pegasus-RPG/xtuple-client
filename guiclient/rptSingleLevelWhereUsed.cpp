...
/*
 *  Constructs a rptSingleLevelWhereUsed as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSingleLevelWhereUsed::rptSingleLevelWhereUsed(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSingleLevelWhereUsed::~rptSingleLevelWhereUsed()
{
 ...
 *  language.
 */
void rptSingleLevelWhereUsed::languageChange()
{
    retranslateUi(this);
}


void rptSingleLevelWhereUsed::init()
{
...
enum SetResponse rptSingleLevelWhereUsed::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptSingleLevelWhereUsed::sPrint()
{
