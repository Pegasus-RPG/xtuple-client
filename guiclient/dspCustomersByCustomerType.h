...
class dspCustomersByCustomerType : public QMainWindow, public Ui::dspCustomersByCustomerType
{
    Q_OBJECT

public:
    dspCustomersByCustomerType(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
