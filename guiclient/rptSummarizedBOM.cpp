...
/*
 *  Constructs a rptSummarizedBOM as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptSummarizedBOM::rptSummarizedBOM(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptSummarizedBOM::~rptSummarizedBOM()
{
 ...
 *  language.
 */
void rptSummarizedBOM::languageChange()
{
    retranslateUi(this);
}


void rptSummarizedBOM::init()
{
  _captive = FALSE;
...
enum SetResponse rptSummarizedBOM::set(ParameterList &pParams)
{
  _captive = TRUE;
