...
/*
 *  Constructs a rptTimePhasedRoughCutByWorkCenter as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedRoughCutByWorkCenter::rptTimePhasedRoughCutByWorkCenter(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedRoughCutByWorkCenter::~rptTimePhasedRoughCutByWorkCenter()
{
 ...
 *  language.
 */
void rptTimePhasedRoughCutByWorkCenter::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedRoughCutByWorkCenter::init()
{
  _captive = FALSE;
...
enum SetResponse rptTimePhasedRoughCutByWorkCenter::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  if (valid)
  {
    ...
    _workCenters->setId(param.toInt());
  }
