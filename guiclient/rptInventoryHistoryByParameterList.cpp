...
/*
 *  Constructs a rptInventoryHistoryByParameterList as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptInventoryHistoryByParameterList::rptInventoryHistoryByParameterList(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptInventoryHistoryByParameterList::~rptInventoryHistoryByParameterList()
{
 ...
 *  language.
 */
void rptInventoryHistoryByParameterList::languageChange()
{
    retranslateUi(this);
}


void rptInventoryHistoryByParameterList::init()
{
  _captive = FALSE;
...
enum SetResponse rptInventoryHistoryByParameterList::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  {
    case ClassCode:
      setCaption(tr("Report Parameters - Inventory History by Class Code"));
      break;

    case PlannerCode:
      setCaption(tr("Report Parameters - Inventory History by Planner Code"));
      break;

    case ItemGroup:
      setCaption(tr("Report Parameters - Inventory History by Item Group"));
      break;
...
void rptInventoryHistoryByParameterList::sPrint()
{
  if (!_dates->allValid())
  {
