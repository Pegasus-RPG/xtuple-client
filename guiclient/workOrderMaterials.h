...
class workOrderMaterials : public QMainWindow, public Ui::workOrderMaterials
{
    Q_OBJECT

public:
    workOrderMaterials(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
    ~workOrderMaterials();
