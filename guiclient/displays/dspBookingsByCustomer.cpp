...
dspBookingsByCustomer::dspBookingsByCustomer(QWidget* parent, const char*, Qt::WFlags fl)
  : display(parent, "dspBookingsByCustomer", fl)
{
  setupUi(optionsWidget());
  setWindowTitle(tr("Bookings by Customer"));
  setListLabel(tr("Bookings"));
  setReportName("BookingsByCustomer");
