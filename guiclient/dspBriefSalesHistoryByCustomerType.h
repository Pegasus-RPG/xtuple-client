...
class dspBriefSalesHistoryByCustomerType : public QMainWindow, public Ui::dspBriefSalesHistoryByCustomerType
{
    Q_OBJECT

public:
    dspBriefSalesHistoryByCustomerType(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
