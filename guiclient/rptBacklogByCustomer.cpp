...
/*
 *  Constructs a rptBacklogByCustomer as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptBacklogByCustomer::rptBacklogByCustomer(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptBacklogByCustomer::~rptBacklogByCustomer()
{
 ...
 *  language.
 */
void rptBacklogByCustomer::languageChange()
{
    retranslateUi(this);
}


void rptBacklogByCustomer::init()
{
  _captive = FALSE;
...
enum SetResponse rptBacklogByCustomer::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptBacklogByCustomer::sPrint()
{
  if (!_cust->isValid())
  {
