...
//  Window
  ...
  //  System | Configure Modules
    ...
    { "sys.configureMS",	tr("Sch&edule..."),	SLOT(sConfigureMS()),	configModulesMenu,	_privileges->check("ConfigureMS"),	NULL,	NULL,	 (_metrics->value("Application") == "Manufacturing" || _metrics->value("Application") == "Standard")	},
