...
//  Window
  ...
  actionProperties acts[] = {
    ...
    { "sys.scheduleSystemMessage",	tr("Schedule S&ystem Message..."),	SLOT(sScheduleSystemMessage()),	systemMenu,	_privleges->check("IssueSystemMessages"),	NULL,	NULL,	_metrics->boolean("EnableBatchManager")		},
    ...
    { "separator",			NULL,					NULL,				systemMenu,	true,						NULL,	NULL,	true	},
    { "sys.scheduleServerMaintenance",	tr("Schedule S&erver Maintenance..."),	SLOT(sScheduleServerMaintenance()),systemMenu,	_privleges->check("MaintainServer"),		NULL,	NULL,	_metrics->boolean("EnableBatchManager")		},
    { "sys.scheduleServerBackup",	tr("Schedule Server Bac&kup..."),	SLOT(sScheduleServerBackup()),	systemMenu,	_privleges->check("BackupServer"),		NULL,	NULL,	_metrics->boolean("EnableBatchManager")		},
    { "separator",			NULL,					NULL,				systemMenu,	true,						NULL,	NULL,	_metrics->boolean("EnableBatchManager")		},

  //  System | Configure Modules
    { "menu",			tr("&Configure Modules"),(char*)configModulesMenu,systemMenu,		true,					NULL,	NULL,	true	},
    { "sys.configurePD",	tr("&Products..."),	SLOT(sConfigurePD()),	configModulesMenu,	_privleges->check("ConfigurePD"),	NULL,	NULL,	true	},
    { "sys.configureIM",	tr("&Inventory..."),	SLOT(sConfigureIM()),	configModulesMenu,	_privleges->check("ConfigureIM"),	NULL,	NULL,	true	},
    { "sys.configurePO",	tr("P&urchase..."),	SLOT(sConfigurePO()),	configModulesMenu,	_privleges->check("ConfigurePO"),	NULL,	NULL,	true	},
    { "sys.configureMS",	tr("Sch&edule..."),	SLOT(sConfigureMS()),	configModulesMenu,	_privleges->check("ConfigureMS"),	NULL,	NULL,	 (_metrics->value("Application") == "OpenMFG")	},
    { "sys.configureWO",	tr("&Manufacture..."),	SLOT(sConfigureWO()),	configModulesMenu,	_privleges->check("ConfigureWO"),	NULL,	NULL,	true	},
    { "sys.configureCRM",	tr("&CRM..."),	SLOT(sConfigureCRM()),	configModulesMenu,	_privleges->check("ConfigureCRM"),	NULL,	NULL,	true	},
    { "sys.configureSO",	tr("&Sales..."),	SLOT(sConfigureSO()),	configModulesMenu,	_privleges->check("ConfigureSO"),	NULL,	NULL,	true	},
    { "sys.configureGL",	tr("&Accounting..."),	SLOT(sConfigureGL()),	configModulesMenu,	_privleges->check("ConfigureGL"),	NULL,	NULL,	true	},
  ...
  //  Master Information
    ...
    { "sys.configureAccountingSystemInterface",tr("Configure Accounting System Interface..."), SLOT(sConfigureAccountingSystemInterface()), masterInfoMenu, _privleges->check("ConfigAccountingInterface"),	NULL,	NULL, _metrics->boolean("EnableExternalAccountingInterface") },
