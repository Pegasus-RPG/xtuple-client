...
/*
 *  Constructs a rptEarnedCommissions as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptEarnedCommissions::rptEarnedCommissions(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptEarnedCommissions::~rptEarnedCommissions()
{
 ...
 *  language.
 */
void rptEarnedCommissions::languageChange()
{
    retranslateUi(this);
}
...
void rptEarnedCommissions::init()
{
  _captive = FALSE;
...
enum SetResponse rptEarnedCommissions::set(ParameterList &pParams)
{
  _captive = TRUE;
