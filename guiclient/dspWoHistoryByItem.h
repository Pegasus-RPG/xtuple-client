...
class dspWoHistoryByItem : public XMainWindow, public Ui::dspWoHistoryByItem
{
    Q_OBJECT

public:
    dspWoHistoryByItem(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
    ~dspWoHistoryByItem();
