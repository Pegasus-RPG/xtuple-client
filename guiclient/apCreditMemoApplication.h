...
class apCreditMemoApplication : public QDialog, public Ui::apCreditMemoApplication
{
    Q_OBJECT

public:
    apCreditMemoApplication(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WFlags fl = 0);
