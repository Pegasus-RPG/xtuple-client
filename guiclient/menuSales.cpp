  ...
  QObject(pParent, "soModule")
{
  ...
  actionProperties acts[] = {
    ...
    { "so.scheduleInvoiceForEmailDelivery",  tr("E-mail Invoice Form..."),	SLOT(sDeliverInvoice()), billingFormsMenu, _privleges->check("PrintInvoices"),	NULL, NULL, _metrics->boolean("EnableBatchManager") , NULL },
...
// END_RW
    ...
    { "so.deliverSalesOrder", tr("E-mail &Sales Order Form..."),	SLOT(sDeliverSalesOrder()), formsMenu, _privleges->check("ViewSalesOrders") ,	NULL, NULL, _metrics->boolean("EnableBatchManager"), NULL },
