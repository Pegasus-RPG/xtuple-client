...
/*
 *  Constructs a rptCostedSingleLevelBOM as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptCostedSingleLevelBOM::rptCostedSingleLevelBOM(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptCostedSingleLevelBOM::~rptCostedSingleLevelBOM()
{
 ...
 *  language.
 */
void rptCostedSingleLevelBOM::languageChange()
{
    retranslateUi(this);
}


void rptCostedSingleLevelBOM::init()
{
  _captive = FALSE;
...
enum SetResponse rptCostedSingleLevelBOM::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptCostedSingleLevelBOM::sPrint()
{
