...
class moduleCP : public QObject
{
  Q_OBJECT

  public:
    moduleCP(OpenMFGGUIClient *);
  ...
  public slots:
    ...
    void sRptTimePhasedDemandByPlannerCode();
    void sRptTimePhasedProductionByItem();
    void sRptTimePhasedProductionByPlannerCode();
