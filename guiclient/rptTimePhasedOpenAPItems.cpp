...
/*
 *  Constructs a rptTimePhasedOpenAPItems as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedOpenAPItems::rptTimePhasedOpenAPItems(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedOpenAPItems::~rptTimePhasedOpenAPItems()
{
 ...
 *  language.
 */
void rptTimePhasedOpenAPItems::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedOpenAPItems::init()
{
  _captive = FALSE;
...
enum SetResponse rptTimePhasedOpenAPItems::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptTimePhasedOpenAPItems::sPrint()
{
  if (_periods->isPeriodSelected())
  {
    orReport report("TimePhasedOpenAPItems", buildParameters());
    if (report.isValid())
      report.print();
    else
    {
...
void rptTimePhasedOpenAPItems::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
...
ParameterList rptTimePhasedOpenAPItems::buildParameters()
{
