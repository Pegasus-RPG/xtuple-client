...
#include "rptMaterialUsageVarianceByWarehouse.h"
...
//  W/O | Reports
  ...
  parent->actions.append( new Action( parent, "wo.rptWoScheduleByItem", tr("Work Order Schedule by Item..."),
                                      this, SLOT(sRptWoScheduleByItem()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );

  parent->actions.append( new Action( parent, "wo.rptWoScheduleByItemGroup", tr("Work Order Schedule by Item Group..."),
                                      this, SLOT(sRptWoScheduleByItemGroup()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );

  parent->actions.append( new Action( parent, "wo.rptWoScheduleByClassCode", tr("Work Order Schedule by Class Code..."),
                                      this, SLOT(sRptWoScheduleByClassCode()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );

  parent->actions.append( new Action( parent, "wo.rptWoScheduleByPlannerCode", tr("Work Order Schedule by Planner Code..."),
                                      this, SLOT(sRptWoScheduleByPlannerCode()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );

  if (_metrics->boolean("Routings"))
      parent->actions.append( new Action( parent, "wo.rptWoScheduleByWorkCenter", tr("Work Order Schedule by Work Center..."),
                                          this, SLOT(sRptWoScheduleByWorkCenter()),
                                          reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) && _metrics->boolean("Routings") ) );

  if (_metrics->boolean("BufferMgt"))
  {
      reportsMenu->insertSeparator();

    //  parent->actions.append( new Action( parent, "wo.rptWoBufferStatusByItem", tr("Work Order Buffer Status by Item..."),
    //                                      this, SLOT(sRptWoBufferStatusByItem()),
    //                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders"))
    //                                      &&  _metrics->boolean("BufferMgt") ) );

      parent->actions.append( new Action( parent, "wo.rptWoBufferStatusByItemGroup", tr("Work Order Buffer Status by Item Group..."),
                                          this, SLOT(sRptWoBufferStatusByItemGroup()),
                                          reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders"))
                                          &&  _metrics->boolean("BufferMgt") ) );
                                                                                
      parent->actions.append( new Action( parent, "wo.rptWoBufferStatusByClassCode", tr("Work Order Buffer Status by Class Code..."),
                                          this, SLOT(sRptWoBufferStatusByClassCode()),
                                          reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders"))
                                          &&  _metrics->boolean("BufferMgt") ) );

      parent->actions.append( new Action( parent, "wo.rptWoBufferStatusByPlannerCode", tr("Work Order Buffer Status by Planner Code..."),
                                          this, SLOT(sRptWoBufferStatusByPlannerCode()),
                                          reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders"))
                                          &&  _metrics->boolean("BufferMgt") ) );
  }
  ...
  parent->actions.append( new Action( parent, "wo.rptWoHistoryByItem", tr("Work Order History by Item..."),
                                      this, SLOT(sRptWoHistoryByItem()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );

  parent->actions.append( new Action( parent, "wo.rptWoHistoryByNumber", tr("Work Order History by W/O Number..."),
                                      this, SLOT(sRptWoHistoryByNumber()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );

  parent->actions.append( new Action( parent, "wo.rptWoHistoryByClassCode", tr("Work Order History by Class Code..."),
                                      this, SLOT(sRptWoHistoryByClassCode()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );

  reportsMenu->insertSeparator();

  parent->actions.append( new Action( parent, "wo.rptWoMaterialRequirementsByComponentItem", tr("W/O Material Requirements by Component Item..."),
                                      this, SLOT(sRptWoMaterialsByComponentItem()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );

  parent->actions.append( new Action( parent, "wo.rptWoMaterialRequirementsByWorkOrder", tr("W/O Material Requirements by Work Order..."),
 ...
 if (_metrics->boolean("Routings") )
 {
      ...
      parent->actions.append( new Action( parent, "wo.rptWoOperationsByWorkCenter", tr("W/O Operations by Work Center..."),
                                          this, SLOT(sRptWoOperationsByWorkCenter()),
                                          reportsMenu, (_privleges->check("MaintainWoOperations") && _privleges->check("ViewWoOperations")) && _metrics->boolean("Routings") ) );

      parent->actions.append( new Action( parent, "wo.rptWoOperationsByWorkOrder", tr("W/O Operations by Work Order..."),
                                          this, SLOT(sRptWoOperationsByWo()),
                                          reportsMenu, (_privleges->check("MaintainWoOperations") && _privleges->check("ViewWoOperations")) && _metrics->boolean("Routings") ) );

      parent->actions.append( new Action( parent, "wo.rptWoOperationBufrStsByWorkCenter", tr("W/O Operation Buffer Status by Work Center..."),
                                          this, SLOT(sRptWoOperationBufrStsByWorkCenter()),
                                          reportsMenu, (_privleges->check("MaintainWoOperations") && _privleges->check("ViewWoOperations")) 
                                          && _metrics->boolean("Routings") &&  _metrics->boolean("BufferMgt") ) );
                                          
      reportsMenu->insertSeparator();

      parent->actions.append( new Action( parent, "wo.rptWoEffortByWorkOrder", tr("Production Time Clock By Work Order..."),
                                          this, SLOT(sRptWoEffortByWorkOrder()),
                                          reportsMenu, _privleges->check("ViewWoTimeClock") && _metrics->boolean("Routings") ) );

      parent->actions.append( new Action( parent, "wo.rptWoEffortByUser", tr("Production Time Clock By User..."),
                                          this, SLOT(sRptWoEffortByUser()),
                                          reportsMenu, _privleges->check("ViewWoTimeClock") && _metrics->boolean("Routings") ) );
  }
  
  reportsMenu->insertSeparator();

  parent->actions.append( new Action( parent, "wo.rptMaterialUsageVarianceByBOMItem", tr("Material Usage Variance by BOM Item..."),
                                      this, SLOT(sRptMaterialUsageVarianceByBOMItem()),
                                      reportsMenu, _privleges->check("ViewMaterialVariances") ) );

  parent->actions.append( new Action( parent, "wo.rptMaterialUsageVarianceByItem", tr("Material Usage Variance by Item..."),
                                      this, SLOT(sRptMaterialUsageVarianceByItem()),
                                      reportsMenu, _privleges->check("ViewMaterialVariances") ) );

  parent->actions.append( new Action( parent, "wo.rptMaterialUsageVarianceByComponentItem", tr("Material Usage Variance by Component Item..."),
                                      this, SLOT(sRptMaterialUsageVarianceByComponentItem()),
                                      reportsMenu, _privleges->check("ViewMaterialVariances") ) );

  parent->actions.append( new Action( parent, "wo.rptMaterialUsageVarianceByWorkOrder", tr("Material Usage Variance by Work Order..."),
                                      this, SLOT(sRptMaterialUsageVarianceByWorkOrder()),
                                      reportsMenu, _privleges->check("ViewMaterialVariances") ) );

  parent->actions.append( new Action( parent, "wo.rptMaterialUsageVarianceByWarehouse", tr("Material Usage Variance by Warehouse..."),
                                      this, SLOT(sRptMaterialUsageVarianceByWarehouse()),
                                      reportsMenu, _privleges->check("ViewMaterialVariances") ) );
 ...
 if (_metrics->boolean("Routings") )
 {
      ...
      parent->actions.append( new Action( parent, "wo.rptLaborVarianceByBOOItem", tr("Labor Variance by BOO Item..."),
                                          this, SLOT(sRptLaborVarianceByBOOItem()),
                                          reportsMenu, _privleges->check("ViewLaborVariances") && _metrics->boolean("Routings") ) );

      parent->actions.append( new Action( parent, "wo.rptLaborVarianceByItem", tr("Labor Variance by Item..."),
                                          this, SLOT(sRptLaborVarianceByItem()),
                                          reportsMenu, _privleges->check("ViewLaborVariances") && _metrics->boolean("Routings") ) );

      parent->actions.append( new Action( parent, "wo.rptLaborVarianceByWorkCenter", tr("Labor Variance by Work Center..."),
                                          this, SLOT(sRptLaborVarianceByWorkCenter()),
                                          reportsMenu, _privleges->check("ViewLaborVariances") && _metrics->boolean("Routings") ) );
  ...
  parent->actions.append( new Action( parent, "wo.rptOpenWorkOrdersWithClosedParentSalesOrders", tr("Open Work Orders with Closed Parent Sales Orders..."),
                                      this, SLOT(sRptWoSoStatusMismatch()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );

  parent->actions.append( new Action( parent, "wo.rptOpenWorkOrdersWithParentSalesOrders", tr("Open Work Orders with Parent Sales Orders..."),
                                      this, SLOT(sRptWoSoStatus()),
                                      reportsMenu, (_privleges->check("MaintainWorkOrders") || _privleges->check("ViewWorkOrders")) ) );
...
void moduleWO::sRptWoScheduleByItem()
{
  rptWoScheduleByItem(parent, "", TRUE).exec();
}

void moduleWO::sRptWoScheduleByItemGroup()
{
  ParameterList params;
  params.append("itemgrp");

  rptWoScheduleByParameterList newdlg(parent, "", TRUE);
  newdlg.set(params);
  newdlg.exec();
}

void moduleWO::sRptWoScheduleByClassCode()
{
  ParameterList params;
  params.append("classcode");
...
void moduleWO::sRptWoScheduleByPlannerCode()
{
  ParameterList params;
  params.append("plancode");
...
void moduleWO::sRptWoScheduleByWorkCenter()
{
  ParameterList params;
  params.append("wrkcnt");
...
void moduleWO::sRptWoBufferStatusByItem()
{
  //rptWoBufferStatusByItem(parent, "", TRUE).exec();
}

void moduleWO::sRptWoBufferStatusByItemGroup()
{
  ParameterList params;
  params.append("itemgrp");

  rptWoBufferStatusByParameterList newdlg(parent, "", TRUE);
  newdlg.set(params);
  newdlg.exec();
}

void moduleWO::sRptWoBufferStatusByClassCode()
{
  ParameterList params;
  params.append("classcode");
...
void moduleWO::sRptWoBufferStatusByPlannerCode()
{
  ParameterList params;
  params.append("plancode");
...
void moduleWO::sRptWoHistoryByItem()
{
  rptWoHistoryByItem(parent, "", TRUE).exec();
}

void moduleWO::sRptWoHistoryByNumber()
{
  rptWoHistoryByNumber(parent, "", TRUE).exec();
}

void moduleWO::sRptWoHistoryByClassCode()
{
  rptWoHistoryByClassCode(parent, "", TRUE).exec();
}

void moduleWO::sRptWoMaterialsByWo()
{
  rptWoMaterialsByWorkOrder(parent, "", TRUE).exec();
}

void moduleWO::sRptWoMaterialsByComponentItem()
{
...
void moduleWO::sRptWoOperationsByWorkCenter()
{
  rptWoOperationsByWorkCenter(parent, "", TRUE).exec();
}

void moduleWO::sRptWoOperationsByWo()
{
  rptWoOperationsByWorkOrder(parent, "", TRUE).exec();
}

void moduleWO::sRptWoOperationBufrStsByWorkCenter()
{
  rptWoOperationBufrStsByWorkCenter(parent, "", TRUE).exec();
}

void moduleWO::sRptMaterialUsageVarianceByBOMItem()
{
  rptMaterialUsageVarianceByBOMItem(parent, "", TRUE).exec();
}

void moduleWO::sRptMaterialUsageVarianceByItem()
{
  rptMaterialUsageVarianceByItem(parent, "", TRUE).exec();
}

void moduleWO::sRptMaterialUsageVarianceByComponentItem()
{
  rptMaterialUsageVarianceByComponentItem(parent, "", TRUE).exec();
}

void moduleWO::sRptMaterialUsageVarianceByWorkOrder()
{
  rptMaterialUsageVarianceByWorkOrder(parent, "", TRUE).exec();
}

void moduleWO::sRptMaterialUsageVarianceByWarehouse()
{
  rptMaterialUsageVarianceByWarehouse(parent, "", TRUE).exec();
}

void moduleWO::sRptWoEffortByWorkOrder()
{
  rptWoEffortByWorkOrder(parent, "", TRUE).exec();
}

void moduleWO::sRptWoEffortByUser()
{
  rptWoEffortByUser(parent, "", TRUE).exec();
}

void moduleWO::sRptLaborVarianceByBOOItem()
{
  rptLaborVarianceByBOOItem(parent, "", TRUE).exec();
}

void moduleWO::sRptLaborVarianceByItem()
{
  rptLaborVarianceByItem(parent, "", TRUE).exec();
}

void moduleWO::sRptLaborVarianceByWorkCenter()
{
  rptLaborVarianceByWorkCenter(parent, "", TRUE).exec();
}
...
{
  rptWoSoStatusMismatch(parent, "", TRUE).exec();
}

void moduleWO::sRptWoSoStatus()
{
  rptWoSoStatus(parent, "", TRUE).exec();
}
