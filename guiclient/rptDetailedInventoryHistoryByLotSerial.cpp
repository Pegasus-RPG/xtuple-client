...
/*
 *  Constructs a rptDetailedInventoryHistoryByLotSerial as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptDetailedInventoryHistoryByLotSerial::rptDetailedInventoryHistoryByLotSerial(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptDetailedInventoryHistoryByLotSerial::~rptDetailedInventoryHistoryByLotSerial()
{
 ...
 *  language.
 */
void rptDetailedInventoryHistoryByLotSerial::languageChange()
{
    retranslateUi(this);
}


void rptDetailedInventoryHistoryByLotSerial::init()
{
...
enum SetResponse rptDetailedInventoryHistoryByLotSerial::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  param = pParams.value("lotSerialNumber", &valid);
  if (valid)
    _lotSerial->setText(param.toString());
...
void rptDetailedInventoryHistoryByLotSerial::sPrint()
{
  if (!_dates->allValid())
  {
