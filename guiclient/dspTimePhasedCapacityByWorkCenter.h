...
class dspTimePhasedCapacityByWorkCenter : public QMainWindow, public Ui::dspTimePhasedCapacityByWorkCenter
{
    Q_OBJECT
...
public slots:
    virtual void sPrint();
    virtual void sPopulateMenu( Q3PopupMenu *, Q3ListViewItem *, int );
...
#endif // DSPTIMEPHASEDCAPACITYBYWORKCENTER_H
