...
/*
 *  Constructs a rptTimePhasedSalesByCustomerByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedSalesByCustomerByItem::rptTimePhasedSalesByCustomerByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedSalesByCustomerByItem::~rptTimePhasedSalesByCustomerByItem()
{
 ...
 *  language.
 */
void rptTimePhasedSalesByCustomerByItem::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedSalesByCustomerByItem::init()
{
  _captive = FALSE;
...
enum SetResponse rptTimePhasedSalesByCustomerByItem::set(ParameterList &pParams)
{
  QVariant param;
  bool     valid;
  ...
  _byCustomer->setChecked(pParams.inList("orderByCustomer"));
  _bySales->setChecked(pParams.inList("orderBySales"));
...
void rptTimePhasedSalesByCustomerByItem::sPrint()
{
...
void rptTimePhasedSalesByCustomerByItem::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
...
ParameterList rptTimePhasedSalesByCustomerByItem::buildParameters()
{
  ...
  else if (_selectedCustomer->isChecked())
