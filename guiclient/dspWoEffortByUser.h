...
class dspWoEffortByUser : public QMainWindow, public Ui::dspWoEffortByUser
{
    Q_OBJECT

public:
    dspWoEffortByUser(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
    ~dspWoEffortByUser();
