    ...
    : QMainWindow(parent, name, fl)
{
  ...
  connect(_incidentSeverities, SIGNAL(populateMenu(Q3PopupMenu *, Q3ListViewItem *, int)), this, SLOT(sPopulateMenu(Q3PopupMenu*)));
  ...
  if (_privleges->check("MaintainIncidentSeverities"))
  {
...
void incidentSeverities::sPopulateMenu( Q3PopupMenu *pMenu)
{
  int menuItem;
