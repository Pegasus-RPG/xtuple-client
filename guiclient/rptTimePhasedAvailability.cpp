...
/*
 *  Constructs a rptTimePhasedAvailability as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedAvailability::rptTimePhasedAvailability(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedAvailability::~rptTimePhasedAvailability()
{
 ...
 *  language.
 */
void rptTimePhasedAvailability::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedAvailability::init()
{
  _captive = FALSE;
...
enum SetResponse rptTimePhasedAvailability::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptTimePhasedAvailability::sPrint()
{
...
void rptTimePhasedAvailability::sSubmit()
{
  if (_calendar->isValid() && (_periods->isPeriodSelected()))
  {
...
ParameterList rptTimePhasedAvailability::buildParameters()
{
