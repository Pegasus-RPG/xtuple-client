...
/*
 *  Constructs a rptTimePhasedProductionByItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedProductionByItem::rptTimePhasedProductionByItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedProductionByItem::~rptTimePhasedProductionByItem()
{
 ...
 *  language.
 */
void rptTimePhasedProductionByItem::languageChange()
{
    retranslateUi(this);
}

enum SetResponse rptTimePhasedProductionByItem::set(ParameterList &pParams)
{
  _captive = TRUE;
  ...
  param = pParams.value("showInactive", &valid);
  if (valid)
    _showInactive->setChecked(param.toBool());
#endif
...
void rptTimePhasedProductionByItem::sPrint()
{
...
void rptTimePhasedProductionByItem::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
...
ParameterList rptTimePhasedProductionByItem::buildParameters()
{
