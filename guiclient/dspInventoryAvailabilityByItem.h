...
class dspInventoryAvailabilityByItem : public QMainWindow, public Ui::dspInventoryAvailabilityByItem
{
    Q_OBJECT

public:
    dspInventoryAvailabilityByItem(QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = Qt::WType_TopLevel);
