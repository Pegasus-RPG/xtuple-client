...
/*
 *  Constructs a rptTimePhasedSalesByCustomer as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
rptTimePhasedSalesByCustomer::rptTimePhasedSalesByCustomer(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
 ...
 */
rptTimePhasedSalesByCustomer::~rptTimePhasedSalesByCustomer()
{
 ...
 *  language.
 */
void rptTimePhasedSalesByCustomer::languageChange()
{
    retranslateUi(this);
}


void rptTimePhasedSalesByCustomer::init()
{
  _captive = FALSE;
...
enum SetResponse rptTimePhasedSalesByCustomer::set(ParameterList &pParams)
{
  _captive = TRUE;
...
void rptTimePhasedSalesByCustomer::sPrint()
{
...
void rptTimePhasedSalesByCustomer::sSubmit()
{
  if (_periods->isPeriodSelected())
  {
...
ParameterList rptTimePhasedSalesByCustomer::buildParameters()
{
