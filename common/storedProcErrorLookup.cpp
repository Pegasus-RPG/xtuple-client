...
{ "deleteEmpgrp",       -1, QT_TRANSLATE_NOOP("storedProcErrorLookup", "The selected Employee Group cannot be deleted "
  ...
  */
  ...
  { "isInventoryItemsite",  -2, QT_TRANSLATE_NOOP("storedProcErrorLookup", "Itemsite is not active."),  0, "" },
  { "isInventoryItemsite",  -3, QT_TRANSLATE_NOOP("storedProcErrorLookup", "Item is not active."),  0, "" },
