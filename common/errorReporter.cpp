...
//{ "lsreg_lsreg_number_key",           Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "A XXX already exists with this XXX.") },
...
//{ "lsseq_lsseq_number_key",           Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "A XXX already exists with this XXX.") },
...
//{ "rev_rev_number_key",                       Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "A XXX already exists with this XXX.") },
...
//{ "tohead_tohead_number_key",                 Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "A XXX already exists with this XXX.") },
